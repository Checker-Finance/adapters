...
func RegisterRoutes(
	...
	// API routes
	v1 := app.Group("/api/v1")
	v1.Post("/quotes", zodiaHandler.CreateRFQHandler)
	v1.Post("/orders", zodiaHandler.ExecuteRFQHandler)
	...
	// Webhook routes
	app.Post("/webhooks/zodia/transactions", webhookHandler.Handle)
}
