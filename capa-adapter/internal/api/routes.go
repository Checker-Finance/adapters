...
func RegisterRoutes(
	...
	resolveHandler *OrderResolveHandler,
	productsHandler *ProductsHandler,
	balanceHandler *BalanceHandler,
	webhookHandler *WebhookAPIHandler,
) {
	...
	// API routes
	v1 := app.Group("/api/v1")
	v1.Post("/quotes", capaHandler.CreateRFQHandler)
	v1.Post("/orders", capaHandler.ExecuteRFQHandler)
	...
	// Webhook routes
	app.Post("/webhooks/capa/transactions", webhookHandler.HandleWebhook)
}
