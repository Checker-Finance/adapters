...
// RFQResponse represents Rio's quotation preview response.
...
// TradeResponse represents a trade execution result from Rio.
...
type RioProductListResponse struct {
	Count   int          `json:"count"`
	Results []RioProduct `json:"results"`
}
