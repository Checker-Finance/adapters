...
func RegisterRoutes(app *fiber.App, nc *nats.Conn, st store.Store, xfxHandler *XFXHandler, resolveHandler *OrderResolveHandler, productsHandler *ProductsHandler, balanceHandler *BalanceHandler) {
